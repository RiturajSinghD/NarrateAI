...
export default function MyVault() {
  ...
  //OPTIMIZED: Unified initialization and explicit tab routing unmount cleanup
  useEffect(() => {
    fetchVaultTracks();
    return () => {
    ...
    <div className="space-y-6 py-2 relative text-white">
      {toast && (
        <div className="fixed top-6 right-6 px-4 py-3 rounded-xl bg-slate-950 border border-cyan-500/20 text-cyan-400 font-bold text-xs flex items-center gap-2 shadow-2xl z-50">
          <CheckCircle className="w-4 h-4 text-cyan-400" /> {toast}
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-slate-900 p-6 text-center space-y-4">
            ...
            <p className="text-xs text-slate-400">
              This action will erase the track permanently.
            </p>
            ...
            >
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-2 rounded-lg bg-white/0 hover:bg-white/5 text-slate-400 hover:text-cyan-400 cursor-pointer"
                ...
                <button
                  ...
                  className="p-2 rounded-lg bg-white/0 hover:bg-white/5 text-slate-400 hover:text-white cursor-pointer"
                  title="Rename Title"
                >
                ...
                <button
                  ...
                  className="p-2 rounded-lg bg-white/0 hover:bg-white/5 text-slate-400 hover:text-red-400 cursor-pointer"
                  title="Delete Asset"
                >
